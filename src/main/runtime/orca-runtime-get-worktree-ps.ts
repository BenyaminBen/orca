...
import { codexStructuredPermissionModeForSettings } from '../codex/codex-structured-permission-mode'
  ...
  async ensureStructuredAgentSessionHost(): Promise<void> {
    await installStructuredAgentSessionHost({
      ...
      resolveCodexPermissionMode: () =>
        codexStructuredPermissionModeForSettings(this.requireStore().getSettings()),
