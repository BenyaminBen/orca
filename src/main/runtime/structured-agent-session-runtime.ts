...
import type { CodexStructuredPermissionMode } from '../codex/codex-structured-permission-mode'
import {
...
export type StructuredAgentSessionRuntimeDeps = {
  ...
  /** The same resolved permission setting for Codex; absent means its approval prompts stay on. */
  resolveCodexPermissionMode?: () => CodexStructuredPermissionMode
  ...
  try {
    ...
    const codex = new CodexStructuredSessionAdapter({
      resolveLaunch: createCodexStructuredLaunchResolver({
        ...
        ...(deps.resolveCodexPermissionMode
          ? { resolvePermissionMode: deps.resolveCodexPermissionMode }
          : {}),
